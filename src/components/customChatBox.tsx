    ...
    <div className="flex flex-col ">
      ...
      <div className="flex flex-col">
        ...
        <div className="w-[300px] h-[50px] border border-gray-500 rounded-full flex items-center px-4 mr-2">
          ...
          <div className="w-[50px] h-[50px] border border-dark-5 rounded-xl flex items-center justify-center bg-[#e6e9ed] hover:bg-[#A005FF] cursor-pointer transition-all ease-in" ><IoIosSend/></div>
        </div>
      </div>
    </div>
  );
